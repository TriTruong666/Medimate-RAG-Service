...
@router.post("/", status_code=status.HTTP_201_CREATED, summary="Tạo mới collection", tags=["Collections"])
...
@router.get("/", status_code=status.HTTP_200_OK, summary="Lấy danh sách collection", tags=["Collections"])
...
@router.get("/{collection_id}", status_code=status.HTTP_200_OK, summary="Lấy chi tiết collection", tags=["Collections"])
...
@router.patch("/{collection_id}", status_code=status.HTTP_200_OK, summary="Cập nhật collection", tags=["Collections"])
...
@router.delete("/{collection_id}", status_code=status.HTTP_200_OK, summary="Xóa collection", tags=["Collections"])
...
@router.post("/{collection_id}/assign-documents", status_code=status.HTTP_200_OK, summary="Gán danh sách tài liệu vào collection (bổ sung)", tags=["Collections"])
...
@router.put("/{collection_id}/documents", status_code=status.HTTP_200_OK, summary="Cập nhật/Sửa danh sách tài liệu trong collection (thay thế)", tags=["Collections"])

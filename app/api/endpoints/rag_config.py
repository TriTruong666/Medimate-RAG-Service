...
@router.get("/current", summary="Lấy cấu hình RAG hiện tại", tags=["RAG Config"], dependencies=[RequireAdmin])
...
@router.get("/", summary="Lấy danh sách cấu hình", tags=["RAG Config"], dependencies=[RequireAdmin])
...
@router.get("/{config_id}", summary="Lấy cấu hình RAG theo ID", tags=["RAG Config"], dependencies=[RequireAdmin])
...
@router.post("/", summary="Tạo cấu hình RAG mới", tags=["RAG Config"], dependencies=[RequireAdmin])
...
@router.put("/{config_id}", summary="Cập nhật cấu hình RAG", tags=["RAG Config"], dependencies=[RequireAdmin])
...
@router.delete("/{config_id}", summary="Xoá cấu hình RAG", tags=["RAG Config"], dependencies=[RequireAdmin])

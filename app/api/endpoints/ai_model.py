...
def get_ai_models(
    ...
    return APIResponse.success(data=result, message="Lấy danh sách AI Model thành công")
...
def get_ai_model(
    ...
    return APIResponse.success(data=result, message="Lấy thông tin AI Model thành công")
...
def update_ai_model(
    ...
    return APIResponse.success(data=result, message="Cập nhật AI Model thành công")
...
def delete_ai_model(
    ...
    return APIResponse.success(message="Xoá AI Model thành công")
